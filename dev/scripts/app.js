...
class App extends React.Component {
    ...
    render()  {
        let newList = (
            ...
            <main>
                <h1 className="titleTwo">List Share <i className="fa fa-pencil-square-o" aria-hidden="true"></i></h1>
                <h2 className="subTitle">Fill in the informaton below to create your list:</h2>
        ...
        let loggedOut = (
            ...
            <header>
                <h1 className="titleTwo">List Share <i className="fa fa-pencil-square-o" aria-hidden="true"></i></h1>
                <h2 className="subTitle">Sign up for an account or log-in to an existing account to begin using <span className="title">List Share</span>.</h2>
            </header>
